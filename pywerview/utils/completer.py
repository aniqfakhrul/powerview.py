...
COMMANDS = {
    ...
    'Get-NetDomain':['-Identity','-Properties','-Select', '-Where'],
    'Get-DomainCA':['-Properties','-Select', '-Where'],
    'Get-NetCA':['-Properties','-Select', '-Where'],
    'Get-DomainGPO':['-Identity','-Properties','-Select', '-Where'],
    'Get-NetGPO':['-Identity','-Properties','-Select', '-Where'],
    'Get-DomainOU':['-Identity','-Properties','-Select','-GPLink', '-Where'],
    'Get-NetOU':['-Identity','-Properties','-Select','-GPLink', '-Where'],
    'Get-DomainGroup':['-Identity','-Properties','-Select', '-Where'],
    'Get-NetGroup':['-Identity','-Properties','-Select', '-Where'],
    'Get-DomainTrust':['-Properties','-Select', '-Where'],
    'Get-NetTrust':['-Properties','-Select', '-Where'],
    'Get-DomainUser':['-Identity','-Properties','-Select','-PreAuthNotRequired','-AdminCount','-TrustedToAuth','-SPN', '-Where'],
    'Get-NetUser':['-Identity','-Properties','-Select','-PreAuthNotRequired','-AdminCount','-TrustedToAuth','-SPN', '-Where'],
    ...
    'Get-DomainObjectAcl':['-Identity','-SecurityIdentifier','-ResolveGUIDs','-Select', '-Where'],
    'Get-ObjectAcl':['-Identity','-ResolveGUIDs','-SecurityIdentifier','-Select', '-Where'],
    ...
    'Add-ADComputer':['-ComputerName','-ComputerPass'],
