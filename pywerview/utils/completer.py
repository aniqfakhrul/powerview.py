...
COMMANDS = {
    ...
    'Get-DomainGPO':['-Identity','-Properties','-LDAPFilter','-Domain','-Select', '-Where'],
    'Get-NetGPO':['-Identity','-Properties','-LDAPFilter','-Domain','-Select', '-Where'],
    'Get-DomainOU':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-GPLink', '-Where'],
    'Get-NetOU':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-GPLink', '-Where'],
    'Get-DomainGroup':['-Identity','-Properties','-LDAPFilter','-AdminCount','-Domain','-Select', '-Where'],
    'Get-NetGroup':['-Identity','-Properties','-LDAPFilter','-AdminCount','-Domain','-Select', '-Where'],
    'Get-DomainTrust':['-Properties','-Domain','-Select', '-Where'],
    'Get-NetTrust':['-Properties','-Domain','-Select', '-Where'],
    'Get-DomainUser':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-PreAuthNotRequired','-AdminCount','-TrustedToAuth','-SPN', '-Where'],
    ...
    'Get-DomainComputer':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS', '-Where'],
    'Get-NetComputer':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS', '-Where'],
