...
COMMANDS = {
    ...
    'Get-DomainGroup':['-Identity','-Properties','-LDAPFilter','-MemberIdentity','-AdminCount','-Domain','-Select', '-Where', '-NoWrap'],
    'Get-NetGroup':['-Identity','-Properties','-LDAPFilter','-MemberIdentity','-AdminCount','-Domain','-Select', '-Where', '-NoWrap'],
    'Get-DomainGroupMember':['-Identity','-LDAPFilter','-Domain','-Select', '-Where', '-NoWrap'],
    'Get-NetGroupmember':['-Identity','-LDAPFilter','-Domain','-Select', '-Where', '-NoWrap'],
    'Get-DomainTrust':['-Properties','-Domain','-Select', '-Where', '-NoWrap'],
    'Get-NetTrust':['-Properties','-Domain','-Select', '-Where', '-NoWrap'],
    'Get-DomainUser':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-RBCD', '-Unconstrained','-PassNotRequired','-PreAuthNotRequired','-AllowDelegation','-DisallowDelegation','-AdminCount','-TrustedToAuth','-SPN', '-Where', '-NoWrap'],
    'Get-NetUser':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-RBCD','-Unconstrained','-PassNotRequired','-PreAuthNotRequired','-AllowDelegation','-DisallowDelegation','-AdminCount','-TrustedToAuth','-SPN', '-Where', '-NoWrap'],
    ...
    'Get-DomainComputer':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS','-RBCD','-SPN','-Printers','-ExcludeDCs','-Where', '-NoWrap'],
    'Get-NetComputer':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS','-RBCD','-SPN','-Printers','-ExcludeDCs', '-Where', '-NoWrap'],
