...
COMMANDS = {
    ...
    'Get-DomainUser':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-PassNotRequired','-PreAuthNotRequired','-AdminCount','-TrustedToAuth','-SPN', '-Where', '-NoWrap'],
    'Get-NetUser':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-PassNotRequired','-PreAuthNotRequired','-AdminCount','-TrustedToAuth','-SPN', '-Where', '-NoWrap'],
