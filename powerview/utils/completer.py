...
COMMANDS = {
    'Get-Domain':['-Identity','-Properties', '-LDAPFilter','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-NetDomain':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'ConvertFrom-SID':['-ObjectSID','-Domain', '-Outfile'],
    'ConvertFrom-UACValue':['-Value','-Domain', '-Outfile'],
    'Get-DomainController':['-Identity','-ResolveSIDs','-SearchBase','-LDAPFilter','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-NetDomainController':['-Identity','-ResolveSIDs','-SearchBase','-LDAPFilter','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-DomainDNSZone':['-Identity','-Properties','-SearchBase','-Domain','-Select','-Where', '-Count', '-NoWrap', '-TableView','-OutFile'],
    'Get-DomainDNSRecord':['-ZoneName','-Identity','-Properties','-SearchBase','-Domain','-Select','-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-DomainCA':['-CheckWebEnrollment','-Properties','-Domain','-Select','-Where', '-Count', '-NoWrap', '-TableView','-OutFile'],
    ...
    'Get-DomainGPO':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-NetGPO':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-DomainGPOLocalGroup':['-Identity','-LDAPFilter','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-GPOLocalGroup':['-Identity','-LDAPFilter','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-DomainOU':['-Identity','-Properties','-SearchBase','-LDAPFilter','-Domain','-Select','-GPLink', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-NetOU':['-Identity','-Properties','-SearchBase','-LDAPFilter','-Domain','-Select','-GPLink', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-DomainGroup':['-Identity','-Properties','-LDAPFilter','-SearchBase','-MemberIdentity','-AdminCount','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView','-OutFile'],
    'Get-NetGroup':['-Identity','-Properties','-LDAPFilter','-SearchBase','-MemberIdentity','-AdminCount','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView','-OutFile'],
    'Get-DomainGroupMember':['-Identity','-LDAPFilter','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView','-OutFile'],
    'Get-NetGroupmember':['-Identity','-LDAPFilter','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView' ,'-OutFile'],
    'Get-DomainForeignGroupMember':['-LDAPFilter','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Find-ForeignGroup':['-LDAPFilter','-Domain','-Select', '-Where', '-Count', '-NoWrap','-OutFile'],
    'Get-DomainForeignUser':['-LDAPFilter','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Find-ForeignUser':['-LDAPFilter','-Domain','-Select', '-Where', '-Count', '-NoWrap','-OutFile'],
    'Get-DomainTrust':['-Identity','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView','-OutFile'],
    'Get-NetTrust':['-Identity','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-DomainUser':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select','-RBCD', '-Unconstrained','-PassNotRequired','-PreAuthNotRequired','-AllowDelegation','-DisallowDelegation','-AdminCount','-TrustedToAuth','-SPN', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-NetUser':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select','-RBCD','-Unconstrained','-PassNotRequired','-PreAuthNotRequired','-AllowDelegation','-DisallowDelegation','-AdminCount','-TrustedToAuth','-SPN', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    ...
    'Get-DomainObject':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView','-OutFile'],
    'Remove-DomainObject':['-Identity','-SearchBase','-Domain','-OutFile'],
    'Remove-ADObject':['-Identity','-SearchBase','-Domain','-OutFile'],
    'Get-ADObject':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    ...
    'Get-DomainObjectAcl':['-Identity','-SearchBase','-Domain','-SecurityIdentifier','-ResolveGUIDs','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-ObjectAcl':['-Identity','-SearchBase','-Domain','-ResolveGUIDs','-SecurityIdentifier','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-DomainComputer':['-Identity','-Properties','-ResolveIP','-ResolveSIDs','-LDAPFilter','-SearchBase','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS', '-BitLocker', '-RBCD','-SPN','-Printers','-ExcludeDCs','-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-NetComputer':['-Identity','-Properties','-ResolveIP','-ResolveSIDs','-LDAPFilter','-SearchBase','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS','-RBCD','-SPN','-Printers','-ExcludeDCs', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    ...
    'Set-ADObject':['-Identity','-Clear','-Set','-Append','-SearchBase','-Domain','-OutFile'],
    'Set-DomainObjectDN':['-Identity','-DistinguishedName','-SearchBase','-Domain','-OutFile'],
    'Set-ADObjectDN':['-Identity','-DistinguishedName','-SearchBase','-Domain','-OutFile'],
    'Set-DomainDNSRecord':['-ZoneName','-RecordName','-RecordAddress','-Domain', '-OutFile'],
    'Remove-DomainDNSRecord':['-ZoneName','-RecordName','-Domain', '-OutFile'],
