...
COMMANDS = {
    ...
    'Remove-DomainCATemplate':['-TemplateName','-Properties','-SearchBase','-Domain','-Select','-Where', '-Count', '-NoWrap', '-OutFile'],
    'Remove-CATemplate':['-TemplateName','-Properties','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile'],
