...
COMMANDS = {
    ...
    'Get-NetDomainController':['-Identity','-ResolveSIDs','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap'],
    ...
    'Get-DomainTrust':['-Identity','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap'],
    'Get-NetTrust':['-Identity','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap'],
    ...
    'Get-ObjectOwner':['-Identity','-ResolveSID','-Domain','-Select', '-Where', '-Count', '-NoWrap'],
    ...
    'Get-DomainComputer':['-Identity','-Properties','-ResolveIP','-ResolveSIDs','-LDAPFilter','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS','-RBCD','-SPN','-Printers','-ExcludeDCs','-Where', '-Count', '-NoWrap'],
    'Get-NetComputer':['-Identity','-Properties','-ResolveIP','-ResolveSIDs','-LDAPFilter','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS','-RBCD','-SPN','-Printers','-ExcludeDCs', '-Where', '-Count', '-NoWrap'],
    ...
    'Remove-DomainDNSRecord':['-ZoneName','-Identity','-Domain'],
    ...
    'Set-DomainUserPassword':['-Identity','-AccountPassword', '-OldPassword','-Domain'],
    'Set-DomainComputerPassword':['-Identity','-AccountPassword', '-OldPassword','-Domain'],
    'Set-DomainObjectOwner':['-TargetIdentity','-PrincipalIdentity','-Domain'],
    'Set-ObjectOwner':['-TargetIdentity','-PrincipalIdentity','-Domain'],
    'clear':'',
    'exit':'',
}
