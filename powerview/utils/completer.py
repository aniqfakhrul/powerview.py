...
COMMANDS = {
    ...
    'Get-DomainGPO':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Server','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-SortBy', '-OutFile', '-NoCache', '-NoVulnCheck', '-Raw', '-ResolveLinks', '-ResolveSecurityFilter'],
    ...
    'Get-DomainGPOSettings':['-Identity','-Properties','-SearchBase','-Server','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-SortBy', '-OutFile', '-NoCache', '-NoVulnCheck', '-Raw'],
    'Get-GPOSettings':['-Identity','-Properties','-SearchBase','-Server','-Select', '-Where', '-Count', '-NoWrap', '-TableView', '-SortBy', '-OutFile', '-NoCache', '-NoVulnCheck', '-Raw'],
    ...
    'Get-EventLog':['-Computer','-ComputerName','-Channel','-EventId','-LogonType','-TargetUser','-MaxEvents','-NewestFirst','-Export','-Raw','-Username','-Password','-Hash','-Server','-Count','-NoWrap','-TableView','-SortBy','-OutFile'],
    ...
    'Add-GPO':['-Identity','-Description','-LinkTo','-BaseDN','-Server','-OutFile'],
