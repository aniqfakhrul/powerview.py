...
COMMANDS = {
    ...
    'Get-DomainCATemplate':['-Identity','-Vulnerable','-Enabled','-Properties','-Domain','-Select','-Where', '-Count', '-NoWrap'],
    'Get-NetCATemplate':['-Identity','-Vulnerable','-Enabled','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap'],
    ...
    'Get-DomainComputer':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS','-RBCD','-SPN','-Printers','-ExcludeDCs','-Where', '-Count', '-NoWrap'],
    'Get-NetComputer':['-Identity','-Properties','-LDAPFilter','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS','-RBCD','-SPN','-Printers','-ExcludeDCs', '-Where', '-Count', '-NoWrap'],
