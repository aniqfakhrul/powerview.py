...
COMMANDS = {
    ...
    'Get-DomainOU':['-Identity','-Properties','-SearchBase','-LDAPFilter','-Server','-Select','-GPLink', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    'Get-NetOU':['-Identity','-Properties','-SearchBase','-LDAPFilter','-Server','-Select','-GPLink', '-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    ...
    'Get-DomainComputer':['-Identity','-Properties','-ResolveIP','-ResolveSIDs','-LDAPFilter','-SearchBase','-Server','-Select','-Unconstrained','-TrustedToAuth', '-LAPS', '-BitLocker', '-RBCD', '-ShadowCred','-SPN','-ReadGMSAPassword','-Printers','-ExcludeDCs','-Where', '-Count', '-NoWrap', '-TableView', '-OutFile'],
    ...
    'New-GPLink':['-GUID','-TargetIdentity','-LinkEnabled','-Enforced','-SearchBase','-Server','-OutFile'],
