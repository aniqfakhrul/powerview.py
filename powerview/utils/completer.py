...
COMMANDS = {
    ...
    'Get-DomainCATemplate':['-Vulnerable','-Enabled','-Properties','-Domain','-Select','-Where', '-Count', '-NoWrap'],
    'Get-NetCATemplate':['-Vulnerable','-Enabled','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap'],
