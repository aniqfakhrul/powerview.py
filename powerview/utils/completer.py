...
COMMANDS = {
    ...
    'Get-DomainController':['-Identity','-ResolveSIDs','-SearchBase','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile'],
    'Get-NetDomainController':['-Identity','-ResolveSIDs','-SearchBase','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile'],
