...
COMMANDS = {
    'Get-Domain':['-Identity','-Properties', '-LDAPFilter','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-NetDomain':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'ConvertFrom-SID':['-ObjectSID','-Domain', '-Outfile'],
    'Get-DomainController':['-Identity','-ResolveSIDs','-SearchBase','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-NetDomainController':['-Identity','-ResolveSIDs','-SearchBase','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-DomainDNSZone':['-Identity','-Properties','-SearchBase','-Domain','-Select','-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-DomainDNSRecord':['-ZoneName','-Identity','-Properties','-SearchBase','-Domain','-Select','-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-DomainCA':['-CheckWebEnrollment','-Properties','-Domain','-Select','-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-CA':['-CheckWebEnrollment','-Properties','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-DomainSCCM':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select','-Where','-Count','-NoWrap','-OutFile', '-Raw'],
    'Get-SCCM':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select','-Where','-Count','-NoWrap','-OutFile', '-Raw'],
    'Get-DomainCATemplate':['-Identity','-Vulnerable','-Enabled','-ResolveSIDs','-Properties','-SearchBase','-Domain','-Select','-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-CATemplate':['-Identity','-Vulnerable','-Enabled','-ResolveSIDs','-Properties','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Add-DomainCATemplate':['-DisplayName','-Name','-Duplicate','-Domain','-NoWrap'],
    'Add-CATemplate':['-DisplayName','-Name','-Duplicate','-Domain','-NoWrap'],
    'Get-DomainGPO':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-NetGPO':['-Identity','-Properties','-LDAPFilter','-SearchBase','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-DomainGPOLocalGroup':['-Identity','-LDAPFilter','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-GPOLocalGroup':['-Identity','-LDAPFilter','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-DomainOU':['-Identity','-Properties','-SearchBase','-LDAPFilter','-Domain','-Select','-GPLink', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-NetOU':['-Identity','-Properties','-SearchBase','-LDAPFilter','-Domain','-Select','-GPLink', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-DomainGroup':['-Identity','-Properties','-LDAPFilter','-SearchBase','-MemberIdentity','-AdminCount','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-NetGroup':['-Identity','-Properties','-LDAPFilter','-SearchBase','-MemberIdentity','-AdminCount','-Domain','-Select', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-DomainGroupMember':['-Identity','-LDAPFilter','-Domain','-Select', '-Where', '-Count', '-NoWrap','-OutFile', '-Raw'],
    ...
    'Get-DomainComputer':['-Identity','-Properties','-ResolveIP','-ResolveSIDs','-LDAPFilter','-SearchBase','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS','-RBCD','-SPN','-Printers','-ExcludeDCs','-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
    'Get-NetComputer':['-Identity','-Properties','-ResolveIP','-ResolveSIDs','-LDAPFilter','-SearchBase','-Domain','-Select','-Unconstrained','-TrustedToAuth', '-LAPS','-RBCD','-SPN','-Printers','-ExcludeDCs', '-Where', '-Count', '-NoWrap', '-OutFile', '-Raw'],
