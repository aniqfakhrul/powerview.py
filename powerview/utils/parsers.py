...
def powerview_arg_parse(cmd):
	...
	# get-eventlog
	get_eventlog_parser = subparsers.add_parser('Get-EventLog', exit_on_error=False)
	get_eventlog_group = get_eventlog_parser.add_mutually_exclusive_group(required=True)
	get_eventlog_group.add_argument('-Computer', action='store', default=None, dest='computer', type=lambda value: escape_filter_chars_except_asterisk(value))
	get_eventlog_group.add_argument('-ComputerName', action='store', default=None, dest='computername', type=lambda value: escape_filter_chars_except_asterisk(value))
	...
	get_eventlog_parser.add_argument('-Raw', action='store_true', default=False, dest='raw')
	get_eventlog_parser.add_argument('-Username', action='store', default=None, dest='username', type=lambda value: escape_filter_chars_except_asterisk(value))
	...
	get_eventlog_parser.add_argument('-NoWrap', action='store_true', default=False, dest='nowrap')
	get_eventlog_parser.add_argument('-OutFile', action='store', dest='outfile')

	# get-eventlogchannel
	get_eventlogchannel_parser = subparsers.add_parser('Get-EventLogChannel', exit_on_error=False)
	get_eventlogchannel_group = get_eventlogchannel_parser.add_mutually_exclusive_group(required=True)
	get_eventlogchannel_group.add_argument('-Computer', action='store', default=None, dest='computer', type=lambda value: escape_filter_chars_except_asterisk(value))
	get_eventlogchannel_group.add_argument('-ComputerName', action='store', default=None, dest='computername', type=lambda value: escape_filter_chars_except_asterisk(value))
	get_eventlogchannel_parser.add_argument('-Username', action='store', default=None, dest='username', type=lambda value: escape_filter_chars_except_asterisk(value))
	get_eventlogchannel_cred_group = get_eventlogchannel_parser.add_mutually_exclusive_group()
	...
	get_eventlogchannel_parser.add_argument('-NoWrap', action='store_true', default=False, dest='nowrap')
	get_eventlogchannel_parser.add_argument('-OutFile', action='store', dest='outfile')

	# get-eventlogpublisher
	get_eventlogpublisher_parser = subparsers.add_parser('Get-EventLogPublisher', exit_on_error=False)
	get_eventlogpublisher_group = get_eventlogpublisher_parser.add_mutually_exclusive_group(required=True)
	get_eventlogpublisher_group.add_argument('-Computer', action='store', default=None, dest='computer', type=lambda value: escape_filter_chars_except_asterisk(value))
	get_eventlogpublisher_group.add_argument('-ComputerName', action='store', default=None, dest='computername', type=lambda value: escape_filter_chars_except_asterisk(value))
	get_eventlogpublisher_parser.add_argument('-Username', action='store', default=None, dest='username', type=lambda value: escape_filter_chars_except_asterisk(value))
	get_eventlogpublisher_cred_group = get_eventlogpublisher_parser.add_mutually_exclusive_group()
	...
	get_eventlogpublisher_parser.add_argument('-NoWrap', action='store_true', default=False, dest='nowrap')
	get_eventlogpublisher_parser.add_argument('-OutFile', action='store', dest='outfile')
